...
- Prefer a pure C++ Provider interface in `UE::Nelaric::` at the boundary. Add a separate Blueprint adapter where Blueprint use is needed; do not force reflection onto every Provider implementation.
